...
<div class="content-wrapper">
    <h3>QA Checks<a href="product_checks/create"><button type="button" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add New</button></a></h3>
                        ...
                        <tbody>
                                ...
                                if (isset($news)) {
                                    foreach ($news->result() as
                                            $new) {
                                        $i++;
                                        $set_publish_url = ADMIN_BASE_URL . 'product_checks/set_publish/' . $new->id;
                                        $set_unpublish_url = ADMIN_BASE_URL . 'product_checks/set_unpublish/' . $new->id ;
                                        $edit_url = ADMIN_BASE_URL . 'product_checks/create/' . $new->id ;
                                        $delete_url = ADMIN_BASE_URL . 'product_checks/delete/' . $new->id;
                                        ?>
                                    <tr id="Row_<?=$new->id?>" class="odd gradeX " >
                                        ...
                                        echo anchor($edit_url, '<i class="fa fa-edit"></i>', array('class' => 'action_edit btn blue c-btn','title' => 'Edit product_checks'));
...
$(document).ready(function(){
    ...
    /*//////////////////////// code for detail //////////////////////////*/
            ...
            //alert(id); return false;
              $.ajax({
                        type: 'POST',
                        url: "<?=ADMIN_BASE_URL?>product_checks/detail",
                        data: {'id': id},
                        async: false,
    ...
    /*///////////////////////// end for code detail //////////////////////////////*/
          ...
          $(document).off('click', '.delete_record').on('click', '.delete_record', function(e){
                ...
                e.preventDefault();
              swal({
                title : "Are you sure to delete the selected product_checks?",
                text : "You will not be able to recover this product_checks!",
                type : "warning",
                ...
                function () {
                       ...
                       $.ajax({
                            type: 'POST',
                            url: "<?=ADMIN_BASE_URL?>product_checks/delete",
                            data: {'id': id},
                            async: false,
                            success: function() {
                            location.reload();
                ...
                swal("Deleted!", "product_checks has been deleted.", "success");
              });
    ...
    /*///////////////////////////////// START STATUS  ///////////////////////////////////*/
        ...
        $(document).off("click",".action_publish").on("click",".action_publish", function(event) {
            ...
            var status = $(this).attr('status');
             $.ajax({
                type: 'POST',
                url: "<?= ADMIN_BASE_URL ?>product_checks/change_status",
