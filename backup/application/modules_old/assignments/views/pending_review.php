                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                      ...
                      <table id="datatable1" class="table table-striped table-hover table-body table-bordered">
                        ...
                        <th class="text-center"style="width:200px;" >Check By <i class="fa fa-sort" style="font-size:13px;"></th>
                        ...
                        <tbody>
                                ...
                                if (isset($news)) {
                                    ...
                                    <tr <?php $any_comments = Modules::run('api/_get_specific_table_with_pagination',array("assignment_id"=>$new->assign_id,"comments !="=>""),'assign_ans_id desc',DEFAULT_OUTLET.'_assignment_answer','comments','1','1')->result_array(); if(!empty($any_comments)) echo 'style="background-color:#f7d16e;"'; ?> id="Row_<?=$new->assign_id?>" class="odd gradeX " >
                                        ...
                                        <td class="text-center">Responsible Team</td>
                                        <td class="text-center">
                                            <?php
                                            if(isset($new->assign_id) && !empty($new->assign_id)) {
                                                $assignment_answer = Modules::run('api/_get_specific_table_with_pagination',array("assignment_id"=>$new->assign_id),'assign_ans_id desc',DEFAULT_OUTLET.'_assignment_answer','user_id','1','1')->result_array();
                                                if(isset($assignment_answer[0]['user_id']) && !empty($assignment_answer[0]['user_id'])) {
                                                    $users = Modules::run('api/_get_specific_table_with_pagination',array("id"=>$assignment_answer[0]['user_id']),'id desc','users','user_name','1','1')->result_array();
