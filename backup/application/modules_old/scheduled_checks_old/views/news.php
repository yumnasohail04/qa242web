...
<div class="content-wrapper">
    <h3>QA Checks<a href="scheduled_checks/create"><button type="button" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add New</button></a></h3>
                        ...
                        <tbody>
                                ...
                                if (isset($news)) {
                                    ...
                                    <tr id="Row_<?=$new->id?>" class="odd gradeX " >
                                        ...
                                        echo '<a href="'.ADMIN_BASE_URL.'scheduled_attributes/manage/'.$new->id.'" class=" btn blue c-btn" title="Manage Attributes"><i class="fa fa-tags" style="color: #B7E031;"></i></a>';
            ...
            var status = $(this).attr('status');
             $.ajax({
                ...
                success: function(result) {
                    ...
                    $("#listing").load('<?=ADMIN_BASE_URL?>scheduled_checks/manage');
