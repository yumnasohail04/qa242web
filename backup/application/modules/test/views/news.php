...
<div class="content-wrapper">
    <h3>Promovideo<a href="test/create"><button type="button" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add New</button></a></h3>
                        ...
                        <tbody>
                                ...
                                if (isset($news)) {
                                    ...
                                    <tr id="Row_<?=$new->id?>" class="odd gradeX " >
                                        ...
                                        <td><?php echo wordwrap($new->test_question , 50 , "<br>\n")  ?></td>
          ...
          $(document).off('click', '.delete_record').on('click', '.delete_record', function(e){
              ...
              swal({
                ...
                function () {
                       ...
                       $.ajax({
                            type: 'POST',
                            url: "<?php ADMIN_BASE_URL?>test/delete",
                            data: {'id': id},
                            async: false,
                            success: function() {
                            location.reload();
