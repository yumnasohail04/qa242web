            ...
            <div class="col-md-12">
                ...
                <div class="portlet box blue">
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                       <form method="post" id="submit_upload_image" action="<?= ADMIN_BASE_URL.'global_configuration/submit_upload_image/';?>" enctype="multipart/form-data">
                            <div class="form-body"> 
...
<script type="text/javascript">
  $(document).off('click', '.submit_upload_image').on('click', '.submit_upload_image', function(e){
    ...
    if( document.getElementById("filetype").files.length == 0 )
      ...
      $('#submit_upload_image').attr('action', "<?= ADMIN_BASE_URL.'global_configuration/submit_upload_image/';?>").submit();
  });
