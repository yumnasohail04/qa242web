 <link href="https://qa.hwryk.com/static/admin/theme1/css/ionicons.min.css" rel="stylesheet">
    <link href="https://qa.hwryk.com/static/admin/theme1/css/typicons.css" rel="stylesheet">
    <link href="https://qa.hwryk.com/static/admin/theme1/css/morris.css" rel="stylesheet">
        ...
        load_dt([{
            ...
            ,   load_events : function () {
                ...
                load_chart_pie_apex_arr([   // Pie Charts for Team
                                        ...
                                        {div_id:"morrisDonut1", chart_title: "CCP", data : {arr_group_by:["CCP","CCP"]
                                        ...
                                        ,{div_id:"morrisDonut2", chart_title: "Pre Op", data : {arr_group_by:["Pre Op","Pre Op"]
                                            , arr_count:[arr_graph_line_is_compliant.reduce((a, b) => a + b, 0),arr_graph_line_is_not_compliant.reduce((a, b) => a + b, 0)]
                                            , arr_result:[] },expression:(x)=>x[circle_index] == 2}
                                        ,{div_id:"morrisDonut3", chart_title: "ATP swab", data : {arr_group_by:["ATP swab","ATP swab"]
                                            , arr_count:[arr_graph_line_is_compliant.reduce((a, b) => a + b, 0),arr_graph_line_is_not_compliant.reduce((a, b) => a + b, 0)]
                                            , arr_result:[] },expression:(x)=>x[circle_index] == 3}    
                                            // Pie Charts for Failed/Passed
                                        ,{div_id:"morrisDonut4", chart_title: "Recieving Log", data : {arr_group_by:["Recieving Log","Recieving Log"]
                                            , arr_count:[arr_graph_line_is_compliant.reduce((a, b) => a + b, 0),arr_graph_line_is_not_compliant.reduce((a, b) => a + b, 0)]
