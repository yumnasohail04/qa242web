            ...
            <div class="col-md-12">
                ...
                <div class="portlet box blue">
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                       <form method="post" id="submited_shift" action="<?= ADMIN_BASE_URL.'notification_setting/submit_shift_data/';?>">
                            <div class="form-body"> 
...
<script type="text/javascript">
  $(document).off('click', '.submited_shift').on('click', '.submited_shift', function(e){
    e.preventDefault();
    if(validateForm()) {
      $('#submited_shift').attr('action', "<?= ADMIN_BASE_URL.'notification_setting/submit_shift_data/';?>").submit();
    }
  });
