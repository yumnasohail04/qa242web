                        ...
                        <tbody>
                                ...
                                if (isset($news)) {
                                    ...
                                    <tr id="Row_<?=$new->id?>" class="odd gradeX " >
                                        ...
                                        echo anchor($edit_url, '<i class="fa fa-edit"></i>', array('class' => 'action_edit btn blue c-btn','title' => 'Edit scheduled_checks'));

                                        echo anchor('"javascript:;"', '<i class="fa fa-times"></i>', array('class' => 'delete_record btn red c-btn', 'rel' => $new->id, 'title' => 'Delete scheduled_checks'));
                                        ?>
                                        </td>
                                    </tr>
                                    <?php } ?>    
