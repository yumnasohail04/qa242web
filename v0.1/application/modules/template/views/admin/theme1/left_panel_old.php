                        ...
                        <ul id="layout_Admin" class="nav sidebar-subnav collapse" style="background:#272C32">
                            ...
                            <li class="<?php if($curr_url.'/'.$secon_curr_url == 'assignments/static_forms_pending'){echo 'active';}    ?>" style="padding-left:15px">
                                    <a class="color_check" href="<?php $controller='assignments/static_forms_pending'; 
                                        echo ADMIN_BASE_URL . $controller ?>">
                                        <em class="fa fa-check"></em>
                                        <span>Pending Review<br>Forms</span>
                                    </a>
                                </li>
                                 <?php
                            }
                            ...
                            <li class="<?php if($curr_url.'/'.$secon_curr_url == 'assignments/static_forms_reviewed'){echo 'active';}    ?>" style="padding-left:15px">
                                    <a class="color_check" href="<?php $controller='assignments/static_forms_reviewed'; 
                                        echo ADMIN_BASE_URL . $controller ?>">
                                        <em class="fa fa-check"></em>
                                        <span>Pending Approval<br>Forms</span>
                                    </a>
                                </li>
                                 <?php
                            }
            ...
            <li class="back_shadow">
                        ...
                        <ul id="layout_supplier" class="nav sidebar-subnav collapse" style="background:#272C32">
                            ...
                            if ($user_data['role'] != 'Admin')
                                ...
                                $permission = true;
                            if ($permission){?>
                                <li class="<?php if($curr_url.'/'.$secon_curr_url == 'ingredients/'){echo 'active';}    ?>" style="padding-left:15px">
                            ...
                            if ($user_data['role'] != 'Admin')
                                ...
                                $permission = true;
                            if ($permission){?>
                                <li class="<?php if($curr_url.'/'.$secon_curr_url == 'supplier/'){echo 'active';}    ?>" style="padding-left:15px">
                            ...
                            if ($user_data['role'] != 'Admin')
                                ...
                                $permission = true;
                            if ($permission){?>
                                <li class="<?php if($curr_url.'/'.$secon_curr_url == 'supplier_doc/'){echo 'active';}    ?>" style="padding-left:15px">
                                    <a class="color_check" href="<?php $controller='supplier_doc/'; 
                                        echo ADMIN_BASE_URL . $controller ?>">
                                        <em class="fa fa-clipboard"></em>
                            ...
                            if ($user_data['role'] != 'Admin')
                                ...
                                $permission = true;
                            if ($permission){?>
                                <li class="<?php if($curr_url.'/'.$secon_curr_url == 'scorecard_form/'){echo 'active';}    ?>" style="padding-left:15px">
                            ...
                            if ($user_data['role'] != 'Admin')
                                ...
                                $permission = true;
                            if ($permission){?>
                                <li class="<?php if($curr_url.'/'.$secon_curr_url == 'scorecard/'){echo 'active';}    ?>" style="padding-left:15px">
