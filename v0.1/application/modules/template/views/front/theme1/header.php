      ...
      <header id="site_header" class="header mobile-menu-hide">
        ...
        <div class="site-nav">
          ...
          <ul id="nav" class="site-main-menu">
            ...
            <li>
              <a class="pt-trigger" href="#ingredient_form" data-animation="59" data-goto="4">Ingredients Form</a>
            </li>
            
            <li>
              <a class="pt-trigger" href="#profile_update" data-animation="59" data-goto="5">Update Profile</a>
            </li>
           
            <li>
              <a class="pt-trigger" href="#security" data-animation="59" data-goto="6">Security</a>
            </li>
            <li>
