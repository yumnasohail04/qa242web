                          ...
                          <div class="col-12">
                            <h1>  <?php 
                                if (empty($update_id)) 
                                    ...
                                    echo $strTitle;
                              ?></h1>
                            <a class="btn btn-sm btn-outline-primary ml-3 d-none d-md-inline-block btn-right" href="<?php echo ADMIN_BASE_URL . 'product_checks'; ?>">&nbsp;&nbsp;&nbsp;Back</a> 
                              ...
                              <form role="form">
                                 <div class="row setup-content" id="step-1">
                                          <div class="col-sm-6" style="display:none;">
                                           ...
                                           <div class="col-sm-6 gen_checktype" <?php if( $news['checktype']=="product attribute") echo ' style="display: none;"';?>>
                                             <div class="form-group">
                                          ...
                                          <div class="col-sm-6 gen_subchecktyp" <?php if($update_id==0 || $news['checktype']=="product attribute") echo ' style="display: none;"';?>>
                                             <div class="form-group" >
                                                <?php 
                                                  if(!empty($arr_sub)) 
                                                    $sub_catchecks =$arr_sub;
                                                  else 
                                                    $sub_catchecks=array();
                                                  if(!isset($news['check_subcat_id']))
                                                    $news['check_subcat_id'] = "";
                                                  $options = array('' => 'Select')+$sub_catchecks ;
                                                  $attribute = array('class' => 'control-label col-md-4');
                                                  echo form_label('Process Check Type <span style="color:red">*</span>', 'role_id', $attribute);
                                                ?>
                                                <div class="col-md-12" id="gen_subchecktyp">
                                                  <?php 
                                                    if($update_id >0 && $news['checktype']=="general qa check"){
                                                      echo form_dropdown('check_subcat_id', $options, $news['check_subcat_id'],  'class="form-control  validatefield select4me" id="subcategory_id" tabindex ="8"');
                                                    }
                                                    else{ ?>
                                          ...
                                          <div class="col-sm-6 gen_program_type" <?php if($update_id==0 || $news['checktype']=="product attribute") echo ' style="display: none;"';?>>
                                            <div class="form-group" >
                                          ...
                                          <div class="col-sm-6 product-select" <?php if(empty($update_id) || $news['productid']==0) echo ' style="display: none;"'?>>
                                          ...
                                          <div class="col-sm-6">
                                           ...
                                           <div class="col-sm-12">
                                             ...
                                             <div class="col-sm-12">
                                          <button class="btn btn-outline-primary  nextBtn  pull-right" type="button"  style="float: right;">Next</button>
                                        </div>
                                    ...
                                    <div class="col-xs-12">
                                       <div class="col-md-12">
                                          ...
                                          <div class="section-box attr-chose">
                                           ...
                                           <?php if($update_id >0){?>
                                             <button class="btn   btn-outline-primary  pull-left mt-30" id="add_attribute" type="button" style="margin-top: 30px;
    margin-left: 30px;">Add new Attribute</button>
     <?}?>
                                 ...
                                 <div class="row setup-content" id="step-3" style="display: none;">
                                          ...
                                          <div class="col-sm-12">
                                            <button class="btn btn-outline-primary  nextBtn  pull-right" style="float: right;    margin-right: 25px;" type="button" >Next</button>
                                            <button type="button" class="btn btn-outline-primary  btn-previousss pull-right">Previous</button>
                                          </div>
                                 </div>
                                       ...
                                       <div class="col-sm-12">
                                        <div class="form-group">
                                          <div class="pretty p-default ">
                                                <label class="col-sm-2">Set Check duration</label>
                                            <input type="checkbox" name="is_dates" style="    margin-top: 12px;" class="validate_form col-sm-4 check_set" <?php if(!empty($news['is_dates'])) echo 'checked="checked"'; ?> />
                                          </div>
                                        </div>
                                      </div>
                                  
                                      
                                    <div class="row datetimeshow"  <?php if(!isset($news['is_dates']) || empty($news['is_dates'])) echo 'style="display: none; width:100%"';?>>
                                       <div class="col-sm-6">
                                          <?php $news_date='';
                                          ...
                                          <div class="form-group">
                                             <?php
                                                ...
                                                $attribute = array('class' => ' col-md-4');
                                                ?>
                                    ...
                                    <?php $news_date='';
                                    	...
                                    	<div class="form-group">
                                         <?php
                                        	...
                                        	<div class="input-group col-md-12 mb-3 datetimepicker1">
												 <?php echo form_input($data); ?> 
                                             <span class="input-group-text input-group-append input-group-addon">
                                                <i class="simple-icon-clock"></i>
                                            </span>
...
<!--                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-actions fluid no-mrg" style="margin-top:6%;width:100%;" >
                                       <div class="row" style="width:100%;">
                                             <div class="col-md-offset-12 col-md-12" style="padding-bottom:15px;">
                                                <span style="margin-left:40px"></span>
                                                <button type="button" class="btn btn-outline-primary  btn-previous ">Previous</button>
                                                ...
                                                <button type="button" class="btn btn-outline-primary green btn-default" style="margin-left:20px;float: right;"><i class="fa fa-undo"></i>&nbsp;Cancel</button>
                                                 ...
                                                 <button type="submit" class="btn btn-outline-primary  btnsave" style="float: right;"><i class="fa fa-check"></i>&nbsp;Save</button>
    ...
    allNextBtn.off('click').click(function(){
      ...
      for(var i=0; i<curInputs.length; i++){
        if (!curInputs[i].validity.valid){
          isValid = false;
       $(curInputs[i]).css("border-color","#f05050")
          $(curInputs[i]).closest(".form-group").addClass("has-error");
        }
      }
      if($('.select2me').val()=='' || $('.select2me').val()=='' || $('.select2me').val()==null || $('.select2me').val()== 'select'){
      ...
      if(program_select == '' || program_select == null || program_select == 'undefined') {
          isValid = false;
          $('.program_type').css("border-color","#f05050");
      }
      else
          $('.program_type').css("border-color","#dde6e9");
    ...
    if(numItems >1){
      ...
      if(attr_id >0 ){
        ...
        function () {
          $.ajax({
            type: 'POST',
            url: "<?php echo  ADMIN_BASE_URL?>product_checks/delete_specific_check_attribute",
 ...
 // previous step
  ...
  <script>
       $(document).on("click", "#add_attribute", function(event){
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo ADMIN_BASE_URL?>product_checks/get_new_attributs_list_from_db",
                ...
                success: function(test_body) {
                    var test_desc = test_body;
                        ...
                        //$("#myModal .modal-title").html(test_title);y
