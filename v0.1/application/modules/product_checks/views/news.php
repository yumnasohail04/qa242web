...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <h1>QA Checks</h1>
            <a class="btn btn-sm btn-outline-primary ml-3 d-none d-md-inline-block btn-right" href="product_checks/create">&nbsp;Add New&nbsp;</a>
                        ...
                        <tbody>
                                ...
                                if (isset($news)) {
                                    ...
                                    <tr id="Row_<?=$new->id?>" class="odd gradeX " >
                                        ...
                                        echo anchor($edit_url, '<i class="iconsminds-file-edit"></i>', array('class' => 'action_edit btn blue c-btn','title' => 'Edit product_checks'));
