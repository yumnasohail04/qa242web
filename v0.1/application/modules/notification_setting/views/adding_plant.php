            ...
            <div class="col-md-12">
                ...
                <div class="portlet box blue">
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                       <form method="post" id="submited_plant" action="<?= ADMIN_BASE_URL.'notification_setting/submit_plant_data/';?>">
                            <div class="form-body"> 
...
<script type="text/javascript">
  $(document).off('click', '.submited_plant').on('click', '.submited_plant', function(e){
    e.preventDefault();
    if(validateForm()) {
      $('#submited_plant').attr('action', "<?= ADMIN_BASE_URL.'notification_setting/submit_plant_data/';?>").submit();
    } else {
      //return
    }
  });
