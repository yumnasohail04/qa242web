...
<script>
  ...
  $('#adding_plant').modal('show');
    $.ajax({
      type: 'POST',
      url: "<?= ADMIN_BASE_URL?>notification_setting/get_plant_html",
      data: {},
      async: false,
  ...
  $('#product_schedules').modal('show');
    $.ajax({
      type: 'POST',
      url: "<?= ADMIN_BASE_URL?>notification_setting/get_product_schedules",
      data: {},
      async: false,
      success: function(test_body) {
  ...
  $('#upload_file').modal('show');
    $.ajax({
      type: 'POST',
      url: "<?= ADMIN_BASE_URL?>notification_setting/get_upload_file",
      data: {},
      async: false,
      success: function(test_body) {
...
<script>
    $("#form_sample_1").submit(function(event){
       event.preventDefault();
        ...
        $.ajax({
                        type: 'POST',
                        url: "<?= ADMIN_BASE_URL?>notification_setting/submit",
...
$(document).off('click', '.delete_record').on('click', '.delete_record', function(e){
  ...
  function () {
    $.ajax({
      type: 'POST',
      url: "<?php ADMIN_BASE_URL?>notification_setting/delete_schedule_product",
      data: {'id': id},
      async: false,
      success: function() {
      location.reload();
...
$(document).off('click', '.adding_line').on('click', '.adding_line', function(e){
  ...
  function () {
    $.ajax({
      type: 'POST',
      url: "<?php ADMIN_BASE_URL?>notification_setting/adding_line",
      data: {},
      async: false,
      success: function() {
      location.reload();
...
$(document).off('click', '.action_edit').on('click', '.action_edit', function(e){
  ...
  e.preventDefault();
    $.ajax({
      type: 'POST',
      url: "<?php ADMIN_BASE_URL?>notification_setting/get_product_schedules",
...
$(document).off('click', '.edit_plant').on('click', '.edit_plant', function(e){
  ...
  $('#adding_plant').modal('show');
    $.ajax({
      type: 'POST',
      url: "<?php ADMIN_BASE_URL?>notification_setting/get_plant_html",
...
$(document).off('click', '.delete_plant').on('click', '.delete_plant', function(e){
  ...
  function () {
    $.ajax({
      type: 'POST',
      url: "<?php ADMIN_BASE_URL?>notification_setting/delete_plant",
      data: {'id': id},
      async: false,
      success: function() {
      location.reload();
...
$(document).off('click', '.delete_shift').on('click', '.delete_shift', function(e){
  ...
  function () {
    $.ajax({
      type: 'POST',
      url: "<?php ADMIN_BASE_URL?>notification_setting/delete_shift",
      data: {'id': id},
      async: false,
      success: function() {
      location.reload();
...
$(document).off('click', '.delete_shift_timing').on('click', '.delete_shift_timing', function(e){
  ...
  function () {
    $.ajax({
      type: 'POST',
      url: "<?php ADMIN_BASE_URL?>notification_setting/delete_shift_timing",
      data: {'id': id},
      async: false,
      success: function() {
      location.reload();
...
$(document).off('click', '.edit_line').on('click', '.edit_line', function(e){
  ...
  $('#adding_line').modal('show');
    $.ajax({
      type: 'POST',
      url: "<?php ADMIN_BASE_URL?>notification_setting/get_line_html",
...
$(document).off('click', '.delete_line').on('click', '.delete_line', function(e){
  ...
  function () {
    $.ajax({
      type: 'POST',
      url: "<?php ADMIN_BASE_URL?>notification_setting/delete_line",
      data: {'id': id},
      async: false,
      success: function() {
      location.reload();
...
$('.line_product').on('change', function() {
  ...
  $(document).on("change", ".add_on", function(event){
    ...
    $.ajax({
      type: "POST",
      url:  "<?= ADMIN_BASE_URL ?>notification_setting/update_line_plants",
  ...
  $('#adding_shift').modal('show');
    $.ajax({
      type: 'POST',
      url: "<?= ADMIN_BASE_URL?>notification_setting/get_shift_html",
      data: {},
      async: false,
      success: function(test_body) {
  ...
  $(document).off('click', '.edit_shift').on('click', '.edit_shift', function(e){
    ...
    $('#adding_shift').modal('show');
      $.ajax({
        type: 'POST',
        url: "<?php ADMIN_BASE_URL?>notification_setting/get_shift_html",
  ...
  $('#adding_shift_timing').modal('show');
    $.ajax({
      type: 'POST',
      url: "<?= ADMIN_BASE_URL?>notification_setting/get_shift_timing_html",
      data: {'from':"add"},
      async: false,
      success: function(test_body) {
  ...
  $(document).off('click', '.edit_shift_timing').on('click', '.edit_shift_timing', function(e){
    ...
    $('#adding_shift_timing').modal('show');
      $.ajax({
        type: 'POST',
        url: "<?php ADMIN_BASE_URL?>notification_setting/get_shift_timing_html",
  ...
  $(document).off("change", ".timezones").on("change", ".timezones", function (event) {
    ...
    if(!$('.checking_previous').text()) {
      $.ajax({
        type: 'POST',
        url: "<?php ADMIN_BASE_URL?>notification_setting/set_outlet_timezone",
