            ...
            <div class="row mb-4">
                <div class="col-12 mb-4">
                    ...
                    <table table id="datatable1" class="data-table data-table-feature">
                        ...
                        <th class="sr">S.No</th>
                        <th>Title</th>
                        <th class="" style="width:400px;">Navision Number</th>
                        ...
                        <tbody>
                                ...
                                if (isset($news)) {
                                    foreach ($news->result() as
                                            $new) {
                                        $i++;
                                        $set_publish_url = ADMIN_BASE_URL . 'herb_spice/set_publish/' . $new->id;
                                        $set_unpublish_url = ADMIN_BASE_URL . 'herb_spice/set_unpublish/' . $new->id ;
                                        $edit_url = ADMIN_BASE_URL . 'herb_spice/create/' .$checkid.'/'. $new->id ;
                                        $delete_url = ADMIN_BASE_URL . 'herb_spice/delete/' . $new->id;
                                        ?>
                                    <tr id="Row_<?=$new->id?>" class="odd gradeX " >
                                        <td width='2%'><?php echo $i;?></td>
                                        <td><?php echo wordwrap($new->product_name , 50 , "<br>\n")  ?></td>
                                        <td><?php echo $new->navision_number ?></td>
...
$(document).ready(function(){
    ...
    /*//////////////////////// code for detail //////////////////////////*/
            ...
            //alert(id); return false;
              $.ajax({
                        type: 'POST',
                        url: "<?php echo ADMIN_BASE_URL?>herb_spice/detail",
                        data: {'id': id},
                        async: false,
          ...
          $(document).off('click', '.delete_record').on('click', '.delete_record', function(e){
              ...
              swal({
                ...
                function () {
                       ...
                       $.ajax({
                            type: 'POST',
                            url: "<?php echo ADMIN_BASE_URL?>herb_spice/delete",
                            data: {'id': id},
                            async: false,
                            success: function() {
                            location.reload();
    ...
    /*///////////////////////////////// START STATUS  ///////////////////////////////////*/
        ...
        $(document).off("click",".action_publish").on("click",".action_publish", function(event) {
            ...
            var status = $(this).attr('status');
             $.ajax({
                type: 'POST',
                url: "<?= ADMIN_BASE_URL ?>herb_spice/change_status",
                ...
                success: function(result) {
                    ...
                    $("#listing").load('<?php echo ADMIN_BASE_URL?>herb_spice/manage');
