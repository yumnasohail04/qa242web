    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <a class="btn btn-sm btn-outline-primary ml-3 d-none d-md-inline-block btn-right" href="ingredient_doc/create">&nbsp;Add New&nbsp;</a>
            ...
            <div class="col-12 mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <thead class="bg-th">
                        <tr class="bg-col">
                        <th>Title <i class="fa fa-sort" style="font-size:13px;"></i></th>
                        ...
                        <tbody>
                                ...
                                if (isset($new)) {
                                    foreach ($new as $key =>$new) {
                                        $i++;
                                        $set_publish_url = ADMIN_BASE_URL . 'ingredient_doc/set_publish/' . $new['id'];
                                        $set_unpublish_url = ADMIN_BASE_URL . 'ingredient_doc/set_unpublish/' . $new['id'] ;
                                        $edit_url = ADMIN_BASE_URL . 'ingredient_doc/create/' . $new['id'] ;
                                        $delete_url = ADMIN_BASE_URL . 'ingredient_doc/delete/' . $new['id'];
                                        $manage_url = ADMIN_BASE_URL . 'ingredient_doc/manage_wips/' . $new['id'];
                                        ?>
...
$(document).ready(function(){
    ...
    /*//////////////////////// code for detail //////////////////////////*/
            ...
            //alert(id); return false;
              $.ajax({
                        type: 'POST',
                        url: "<?php echo ADMIN_BASE_URL?>ingredient_doc/detail",
                        data: {'id': id},
                        async: false,
          ...
          $(document).off('click', '.delete_record').on('click', '.delete_record', function(e){
              ...
              swal({
                ...
                function () {
                       ...
                       $.ajax({
                            type: 'POST',
                            url: "<?php echo ADMIN_BASE_URL?>ingredient_doc/delete",
                            data: {'id': id},
                            async: false,
                            success: function() {
                                location.reload();
    ...
    /*///////////////////////////////// START STATUS  ///////////////////////////////////*/
        ...
        $(document).off("click",".action_publish").on("click",".action_publish", function(event) {
            ...
            var status = $(this).attr('status');
             $.ajax({
                type: 'POST',
                url: "<?= ADMIN_BASE_URL ?>ingredient_doc/change_status",
