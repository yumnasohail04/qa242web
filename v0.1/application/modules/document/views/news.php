    ...
    <main>
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1>Document</h1>
                    <a class="btn btn-sm btn-outline-primary ml-3 d-none d-md-inline-block btn-right" href="document/create">&nbsp;Add New&nbsp;</a>
                        ...
                        <tbody>
                                ...
                                if (isset($news)) {
                                    ...
                                    <tr id="Row_<?=$new['id']?>" class="odd gradeX " >
                                        ...
                                        <td><?php  foreach($new['type'] as $keys =>$val){ echo $val['name'].'<br>'; }?></td>
