        ...
        if (isset($product_schedule) && !empty($product_schedule)) {
            ...
            foreach ($product_schedule as $keyy=>$produc):?>
                <trr id="Row_<?=$counter?>" class="backgroud-blue ">
                    <tdd colspan="7"  class="border_color_blue" style="border-right:none !important;"><?=$produc['day']?>(<?=$produc['date']?>)</tdd>
                </trr>
                <?php if(isset($produc['data']) && !empty($produc['data'])) {
                    ...
                    $counter++; ?>
                    <trr  id="Row_<?=$counter?>" class="odd gradeX " >
                        <tdd colspan="7"  class="text-center red-color" style="border:none !important;text-align: right;font-weight:bold;">No schedules for the day</tdd>
                    </trr>
                <?php }
            endforeach;
        }
                ...
                <trr class="odd">
                    <tdd valign="top" colspan="7" class="dataTables_empty">
