    ...
    <div class="content-wrapper">
      ...
      <h3>
        ...
        if (empty($update_id)) 
                    ...
                    echo $strTitle;
                    ?>
                    <a href="<?php echo ADMIN_BASE_URL . 'supplier_doc'; ?>"><button type="button" class="btn btn-primary pull-right"><i class="fa fa-chevron-left"></i>&nbsp;&nbsp;&nbsp;Back</button></a>
       </h3>             
                ...
                <div class="portlet-body form " style="padding-top:15px;"> 
                  ...
                  <!-- BEGIN FORM-->
                        ...
                        if (isset($hidden) && !empty($hidden))
                            echo form_open_multipart(ADMIN_BASE_URL . 'supplier_doc/submit/' . $update_id, $attributes, $hidden);
                        else
                            echo form_open_multipart(ADMIN_BASE_URL . 'supplier_doc/submit/' . $update_id, $attributes);
                        ?>
                  <div class="form-body section-box">
                    ...
                    <div class="row">
                        <fieldset>
                            <legend>Supplier Document</legend>
                         <div class="col-sm-5">
                    ...
                    <div class="col-md-6">
                      <div class="col-md-offset-2 col-md-9" style="padding-bottom:15px;">
                       <span style="margin-left:40px"></span> <button type="submit" class="btn btn-primary submited_form"><i class="fa fa-check"></i>&nbsp;Save</button>
                        <a href="<?php echo ADMIN_BASE_URL . 'supplier_doc'; ?>">
