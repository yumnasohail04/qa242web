...
<div class="content-wrapper">
    <h3>Carrier and Storage<a href="carrier/create"><button type="button" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add New</button></a> </h3>
                        ...
                        <tbody>
                                ...
                                if (isset($news)) {
                                    ...
                                    <tr id="Row_<?=$new->id?>" class="odd gradeX " >
                                        ...
                                        echo anchor($edit_url, '<i class="fa fa-edit"></i>', array('class' => 'action_edit btn blue c-btn','title' => 'Edit carrier'));

                                        /*echo anchor('"javascript:;"', '<i class="fa fa-times"></i>', array('class' => 'delete_record btn red c-btn', 'rel' => $new->id, 'title' => 'Delete carrier'));*/
                                        ?>
                                        </td>
                                    </tr>
                                    <?php } ?>    
