            ...
            <tr data-id="<?php echo $values['id']; ?>">
                <?php if(!empty($values['sub_question'])) {  ?>
                    ...
                    <td style="width: 120px; margin-right: 3px;">
                        <input type="radio" id="check_answer" <?php if( isset($values['sub_ans']->option) && $values['sub_ans']->option=="1") echo "checked";?>  name="answer_<?php echo $keys ?>" value="1">Yes
                        <input type="radio" id="check_answer" <?php if( isset($values['sub_ans']->option) && $values['sub_ans']->option=="0") echo "checked";?> name="answer_<?php echo $keys ?>" style="margin-left: 17px;margin-right: 3px;" value="0">No</td>
                <?php } else{?>
                    <td></td>
                    <td></td>
                <?php }?>
