                          ...
                          <div class="col-12">
                            <h1>   <?php 
                              if (empty($update_id)) 
                                ...
                                echo $strTitle;
                           ?></h1>
                            <a class="btn btn-sm btn-outline-primary ml-3 d-none d-md-inline-block btn-right" href="<?php echo ADMIN_BASE_URL . 'scheduled_checks'; ?>">&nbsp;&nbsp;&nbsp;Back</a> 
                                 ...
                                 <div class="row setup-content" id="step-1">
                                          ...
                                          <div class="col-sm-6 gen_program_type" <?php if($update_id==0 || $news['checktype']=="product attribute") echo ' style="display: none;"';?>>
                                            <div class="form-group" >
                                                ...
                                                <div class="col-md-12">
                                                  <select multiple="multiple" class=" select-1 form-control program_type  " name="program_type[]" required="required">
                                                    <?php 
                                          ...
                                          <div class="col-sm-6">
                                           ...
                                           <div class="col-sm-12">
                                             ...
                                             <div class="col-sm-12">
                                          <button style="float:right;" class="btn btn-outline-primary nextBtn  pull-right" type="button" >Next</button>
                                        </div>
    ...
    margin-left: 30px;">Add new Attribute</button>
     <?}?>
                                 ...
                                 <div class="row setup-content" id="step-3" style="display: none;">
                                       ...
                                       <button type="button" class="btn   btn-outline-primary  btn-previousss pull-right">Previous</button> </div>
                                 ...
                                 <div class="row setup-content" id="step-4" style="display: none;">
                                       ...
                                       <div class="col-sm-6">
                                        <div class="form-group">
                                          <div class="pretty p-default ">
                                            ...
                                            <input type="checkbox" name="is_dates" class="validate_form col-sm-12 check_set" <?php if(!empty($news['is_dates'])) echo 'checked="checked" value="1"'; ?> />
                                          </div>
                                        </div>
                                      </div>
                                    ...
                                    <div class="col-md-12 col-md-12" style="padding-bottom:15px;">
