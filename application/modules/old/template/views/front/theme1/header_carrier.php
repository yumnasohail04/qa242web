      ...
      <header id="site_header" class="header mobile-menu-hide">
        ...
        <div class="site-nav">
          ...
          <ul id="nav" class="site-main-menu">
            ...
            <li>
              <a class="pt-trigger" href="#profile_update" data-animation="59" data-goto="2">Update Profile</a>
            </li>
            <li>
            ...
            <li>
              <a  href="<?php echo BASE_URL.'carrier/logout/'.$detail['id'] ?>">logout</a>
            </li>
          </ul>
          <!-- /Main menu -->
        </div>
