...
class Static_form extends MX_Controller
{
    ...
    function get_range_attribute_detail($ParentId,$sfq_id,$sfa_id){
        $temp_data=array();
         $range_data = Modules::run('api/_get_specific_table_with_pagination_where_groupby',array("sfq_check_id" =>$ParentId,'sfq_id'=>$sfq_id), 'sfq_id desc', 'sfq_id',DEFAULT_OUTLET.'_static_form_question','sfq_id,sfq_question','1','0','','','')->result_array();
