                               ...
                               <div class="row add_row" >
                                    ...
                                    <div class="possible_select" <?php if($update_id==0 ) echo 'style="display:none;"'?>>
                                     ...
                                     <div class="col-md-12 " style="margin-bottom:20px;">
                                      ...
                                      <?  }elseif(ucfirst($attribute_type)=="Text" || ucfirst($attribute_type)=="DateTime" || ucfirst($attribute_type)=="Date" || ucfirst($attribute_type)=="Time"){?>
                                         ...
                                         <?}?>
                                       <?php if(!empty($attribute_type) && $attribute_type=="range"){
                                      
                                       
                                       ?>
                                            <?php if($sfa_answer_acceptance=="refrigerated"){
                                            
                                            ?>
                                       <div class="col-md-5"> <div class="form-group"> <label for="txtCatName" class="control-label col-md-4">Min Value<span class="red" style="color:red;">*</span></label> <div class="col-md-8"> <input type="text" name="refrigerated_min_value" value="<?=$sfa_min?>" id="refrigerated_min_value" class="form-control validate[required] text-input " required="required"> </div></div></div><div class="col-md-6"> <div class="form-group"> <label for="txtCatName" class="control-label col-md-4">Max Value<span class="red" style="color:red;">*</span></label> <div class="col-md-8"> <input type="text" name="refrigerated_max_value" value="<?=$sfa_max?>" id="refrigerated_max_value" class="form-control validate[required] text-input " required="required"> </div></div></div><div class="col-md-5 marging"> <div class="form-group"> <label for="txtCatName" class="control-label col-md-4">Target Value<span class="red" style="color:red;">*</span></label> <div class="col-md-8"> <input type="text" name="refrigerated_target_value" value="<?=$sfa_target?>" id="possible_answer" class="form-control validate[required] text-input " required="required"> </div></div></div>
                                       <?}elseif($sfa_answer_acceptance=="frozen"){?>
                                       <span class="marging frozensec col-md-12"><div class="col-md-5"> <div class="form-group"> <label for="txtCatName" class="control-label col-md-4">Frozen Min Value<span class="red" style="color:red;">*</span></label> <div class="col-md-8"> <input type="text" name="frozen_min_value" value="<?=$sfa_min?>" id="refrigerated_min_value" class="form-control validate[required] text-input " required="required"> </div></div></div><div class="col-md-6"> <div class="form-group"> <label for="txtCatName" class="control-label col-md-4">Frozen Max Value<span class="red" style="color:red;">*</span></label> <div class="col-md-8"> <input type="text" name="frozen_max_value" value="<?=$sfa_max?>" id="frozen_max_value" class="form-control validate[required] text-input " required="required"> </div></div></div><div class="col-md-5 marging"> <div class="form-group"> <label for="txtCatName" class="control-label col-md-4">Target Value<span class="red" style="color:red;">*</span></label> <div class="col-md-8"> <input type="text" name="frozen_target_value" value="<?=$sfa_target?>" id="frozen_target_value" class="form-control validate[required] text-input " required="required"> </div></div></div></span>
                                       <?}}?>     
                                     </div>
