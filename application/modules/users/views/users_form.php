                    ...
                    <div class="col-sm-5">
                      <div class="form-group">
                       <?php if(!isset($groups)) $groups = array();
                          ...
                          <?php $options = array('' => 'Select')+$groups ;
                          $attribute = array('class' => 'control-label col-md-4');
                          echo form_label('Secondary Group <span style="color:red">*</span>', 'role_id', $attribute);?>
                          <div class="col-md-8">
                            <?php echo form_dropdown('second_group', $options, $users['second_group'],  'class="form-control select2me required validatefield" id="role_id" tabindex ="8"'); ?>
                        </div>
                      </div>
                    </div>
