            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <table id="datatable1" class="table table-bordered table-hover">
                        <thead class="bg-th">
                            <tr class="bg-col">
                                <th>User Name <i class="fa fa-sort" style="font-size:13px;"></i></th>
                    ...
                    <tr id="Row_<?=$row['id']?>" class="odd gradeX">
                       ...
                       <td class="table_action" style="text-align: center;">
                            ...
                            <a class="btn black c-btn change_password" rel="<?=$row['id']?>"><i class="fa fa-eye"  title="Change Password"></i></a>
                            <?php
