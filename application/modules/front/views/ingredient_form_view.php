            ...
            <tr>
                ...
                <?php if($value['type']=="choice"){ 
                    ...
                    <?php }
                        ...
                        if(isset($value['ans_options']) && !empty($value['ans_options'])){
                        foreach($value['ans_options'] as $a =>$ans_val): ?>
                    <div class="input-group datetimepicker2 mb-3 ">
                ...
                <?php if($value['expiry']==1){?>
                    <div class="input-group  mb-3 datetimepicker2">
...
<button id="submited_ing_form" class="btn btn-sm btn-success" type="submit"> Save</button>
<button  class="btn btn-sm btn-success  btn-validate-doc-form"> Validate</button>
<button  class="btn btn-sm btn-success  btn-submit-ing-form">Submit</button>
