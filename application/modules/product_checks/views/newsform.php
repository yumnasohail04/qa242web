     ...
     <?}?>
                                 ...
                                 <div class="row setup-content" id="step-3" style="display: none;">
                                    <div class="col-xs-12">
                                       ...
                                       <button class="btn btn-primary nextBtn  pull-right" style="    margin-right: 25px;" type="button" >Next</button>
                                 ...
                                 <div class="row setup-content" id="step-4" style="display: none;">
                                       ...
                                       <div class="col-sm-5">
                                        <div class="form-group">
                                          <div class="pretty p-default ">
                                            ...
                                            <input type="checkbox" name="is_dates" style="    margin-top: 12px;" class="validate_form col-sm-8 check_set" <?php if(!empty($news['is_dates'])) echo 'checked="checked"'; ?> />
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="form-actions fluid no-mrg" style="margin-top:6%;">
                                       <div class="row">
                                          <div class="col-md-6">
