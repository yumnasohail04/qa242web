                        ...
                        <tbody>
                                ...
                                if (isset($news)) {
                                    foreach ($news->result() as
                                            $new) {
                                        $i++;
                                        $set_publish_url = ADMIN_BASE_URL . 'herbspice_checks/set_publish/' . $new->id;
                                        $set_unpublish_url = ADMIN_BASE_URL . 'herbspice_checks/set_unpublish/' . $new->id ;
                                        $edit_url = ADMIN_BASE_URL . 'herbspice_checks/create/' . $new->id ;
                                        $delete_url = ADMIN_BASE_URL . 'herbspice_checks/delete/' . $new->id;
                                        ?>
...
$(document).ready(function(){
    ...
    /*//////////////////////// code for detail //////////////////////////*/
            ...
            //alert(id); return false;
              $.ajax({
                        type: 'POST',
                        url: "<?=ADMIN_BASE_URL?>herbspice_checks/detail",
                        data: {'id': id},
                        async: false,
          ...
          $(document).off('click', '.delete_record').on('click', '.delete_record', function(e){
              ...
              swal({
                ...
                function () {
                       ...
                       $.ajax({
                            type: 'POST',
                            url: "<?=ADMIN_BASE_URL?>herbspice_checks/delete",
                            data: {'id': id},
                            async: false,
                            success: function() {
                            location.reload();
                ...
                swal("Deleted!", "herbspice checks has been deleted.", "success");
              });
    ...
    /*///////////////////////////////// START STATUS  ///////////////////////////////////*/
        ...
        $(document).off("click",".action_publish").on("click",".action_publish", function(event) {
            ...
            var status = $(this).attr('status');
             $.ajax({
                type: 'POST',
                url: "<?= ADMIN_BASE_URL ?>herbspice_checks/change_status",
                ...
                success: function(result) {
                    ...
                    $("#listing").load('<?=ADMIN_BASE_URL?>herbspice_checks/manage');
