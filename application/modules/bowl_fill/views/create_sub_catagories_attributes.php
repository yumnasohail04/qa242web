          ...
          $update_id=$this->uri->segment(4);
            ...
            else
            {
               $strTitle = "Add attribute";
                    ...
                    echo $strTitle;
                    ?>
                    <a href="<?php echo ADMIN_BASE_URL.'wip_profile'?>"><button type="button" class="btn btn-primary pull-right"><i class="fa fa-chevron-left"></i>&nbsp;&nbsp;&nbsp;Back</button></a>
    </h3>
    </div>
    <div class="row">
      <div class="col-md-12">
              ...
              <div class="portlet box green ">
                ...
                <div class="portlet-body form " style="padding-top:15px;"> 
                  ...
                  <!-- BEGIN FORM-->
                          ...
                          echo form_open_multipart(ADMIN_BASE_URL.'bowl_fill/submit_sub_catagories_attributes/'.$update_id, $attributes, $hidden); ?>
                                    <div class="form-body">
