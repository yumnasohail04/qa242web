                                           ...
                                           <div class="form-group">
                                              ...
                                              <div class="col-sm-12">
                                                 <select  class="validate_form form-control responsible_user" name="responsible_user" required="required">
                                                    ...
                                                    <?php if(isset($selected_user) && $selected_user==$value['id']) echo 'selected="selected"'?>><?= $value['first_name'].' '.$value['last_name']?></option>
                                                    <?php endforeach ?>
                                                 </select>
                                              </div>
                                           </div>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-12">
                                             <select multiple="" class="validate_form form-control question_type select-1 " name="groups[]" required="required">
                                                ...
                                                <option value="<?=$qa['question_id']?>" <?php if(isset($arr_question[$i]) && !empty($arr_question[$i]) && $arr_question[$i]['rq_question_id']==$qa['question_id']) echo 'selected="selected"'; ?> >
                                                  <?=$qa['question']?>
                                                </option>
                                                <?php endforeach ?>
                                             </select>
