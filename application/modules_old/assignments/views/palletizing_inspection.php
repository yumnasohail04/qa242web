                        ...
                        <table class="table table-striped table-hover table-body table-bordered">
                            <thead class="bg-th">
                                <tr class="bg-col">
                                    ...
                                    <th class="text-center" style="width:200px;">Item No.<i class="fa fa-sort" style="font-size:13px;"></th>
                                    <th class="text-center"style="width:200px;" >Cases<i class="fa fa-sort" style="font-size:13px;"></th>
                            ...
                            <tbody id="ajax_content_wrapper">
                                ...
                                if (isset($inspection)) {
                                    foreach ($inspection->result() as
                                        ...
                                        $i++;
                                        ?>
                                    <tr  id="Row_<?=$new->pi_id?>" class="odd gradeX "  >
                                        ...
                                        <td>
                                            <a class="btn yellow c-btn view_details" rel="<?=$new->pi_id?>">
                                                <i class="fa fa-list"  title="See Detail"></i>
                                            </a>
                                        </td>
                                    </tr>
                                    <?php } ?>    
...
$(document).ready(function(){
    ...
    /*//////////////////////// code for detail //////////////////////////*/
            ...
            var id = $(this).attr('rel');
              $.ajax({
                        type: 'POST',
                        url: "<?= ADMIN_BASE_URL?>assignments/palletizing_inspection_detail",
                        data: {'id': id},
                        async: false,
...
<script>
    ...
    function ajax_call(page_number,startdate,enddate) {
        citycurrentRequest= $.ajax({
            type: "POST",  
            url: '<?= ADMIN_BASE_URL?>assignments/get_palletizing_search',  
