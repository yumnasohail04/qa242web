            ...
            <div class="col-md-12">
                ...
                <div class="portlet box blue">
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                       <form method="post" id="submited_shift_timing" action="<?= ADMIN_BASE_URL.'notification_setting/submit_shift_timing_data/';?>">
                            <div class="form-body"> 
...
<script type="text/javascript">
  $(document).off('click', '.submited_shift_timing').on('click', '.submited_shift_timing', function(e){
    e.preventDefault();
    if(validateForm()) {
      $('#submited_shift_timing').attr('action', "<?= ADMIN_BASE_URL.'notification_setting/submit_shift_timing_data/';?>").submit();
    }
  });
