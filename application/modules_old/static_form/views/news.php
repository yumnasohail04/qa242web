...
<div class="content-wrapper">
    <h3>Promovideo<a href="static_form/create"><button type="button" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add New</button></a></h3>
                        ...
                        <tbody>
                                ...
                                if (isset($static_form) && !empty($static_form)) {
                                    ...
                                    <tr id="Row_<?=$sf->sf_id?>" class="odd gradeX">
                                        <td>
                                            <?php echo date('m-d-Y',strtotime($sf->sf_start_datetime)); ?>
                                        </td>
                                        <td>
                                            <?php echo date('H:i:s',strtotime($sf->sf_start_datetime)); ?>
                                        </td>
                                        <td>
                                            <?php echo $sf->sf_name; ?>
                                        </td>
                                       ...
                                       <?php
                                        ...
                                        echo anchor('"javascript:;"', '<i class="fa fa-times"></i>', array('class' => 'delete_record btn red c-btn', 'rel' => $sf->sf_status, 'title' => 'Delete Check'));
                                        ?>
                                        </td>
                                    </tr>
                                    <?php } ?>    
...
$(document).ready(function(){
    ...
    /*//////////////////////// code for detail //////////////////////////*/
            ...
            //alert(id); return false;
              $.ajax({
                        type: 'POST',
                        url: "<?php ADMIN_BASE_URL?>static_form/detail",
                        data: {'id': id},
                        async: false,
          ...
          $(document).off('click', '.delete_record').on('click', '.delete_record', function(e){
              ...
              swal({
                ...
                function () {
                   $.ajax({
                        type: 'POST',
                        url: "<?php ADMIN_BASE_URL?>static_form/delete",
                        data: {'id': id},
                        async: false,
                        success: function() {
                        location.reload();
