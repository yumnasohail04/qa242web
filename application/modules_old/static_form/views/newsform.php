                    ...
                    <div class="row">
                      <div class="col-sm-5" >
                        <div class="form-group">
                          ...
                          ?>
                          <?php echo form_label('Check Name', 'txtPhone', $attribute); ?>
                          <div class="col-md-8">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label class="col-sm-4 control-label">Inspection Team</label>
                          <div class="col-sm-8">
                      ...
                      <div class="col-sm-5">
                        <div class="form-group">
                          <label class="col-sm-4 control-label">Review Team</label>
                          <div class="col-sm-8">
                            <select class="form-control" name="review_team" required="required">
                              <option >Select</option>
                              <?php if(!isset($groups) || empty($groups))
                                      $groups = array();
                                foreach ($groups as $value): ?>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label class="col-sm-4 control-label">Approve Team</label>
                          <div class="col-sm-8">
                            <select class="form-control" name="approve_team" required="required">
                              <option >Select</option>
                              <?php if(!isset($groups) || empty($groups))
                                      $groups = array();
                                foreach ($groups as $value): ?>
...
<script type="text/javascript">
  $(document).off('click', '.submit_from').on('click', '.submit_from', function(e){
    $('.submit_from').attr('action', "<?= ADMIN_BASE_URL.'static_form/submit/';?>").submit();
    /*e.preventDefault();
    if(validateForm()) {
      alert(validateForm());
      $('.submit_from').attr('action', "<?= ADMIN_BASE_URL.'static_form/submit/';?>").submit();
  ...
  function validateForm() {
    ...
    if($('.inspection_team').val() == '' || $('.inspection_team').val() == null || $('.inspection_team').val()== 'undefined')
      $('.inspection_team').parent().find('.chosen-choices').addClass('red');
    else
      $('.inspection_team').parent().find('.chosen-choices').removeClass('red');
