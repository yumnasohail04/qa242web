                               ...
                               <div class="row add_row" >
                                                 ...
                                                 <?php $attribute = array('class' => 'control-label col-md-4');
                                                    ...
                                                    <div class="col-md-8">
                                                       <select name="attribute_type" class="form-control answer_type" required="required">
                                                          ...
                                                          <?php if(!isset($catagories['attribute_type']))
                                                            $catagories['attribute_type']="";
                                                          ?>
                                                        ...
                                                        <option value="DateTime" <?php if($catagories['attribute_type']=="Text") echo 'selected="selected"';?>>DateTime</option>
                                                        <option value="Date" <?php if($catagories['attribute_type']=="Text") echo 'selected="selected"';?>>Date</option>
                                                        <option value="Time" <?php if($catagories['attribute_type']=="Text") echo 'selected="selected"';?>>Time</option>
                                                       </select>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="possible_select" <?php if($update_id==0 ) echo 'style="display:none;"'?>>
                                     ...
                                     <div class="col-md-12 " style="margin-bottom:20px;">
                                                ...
                                                <?php if(!isset($catagories['possible_answers']))
                                                $catagories['possible_answers'] = ""; ?>
                                            		<div class="col-md-5">
                                      ...
                                      <?  }elseif($catagories['attribute_type']=="Text" || $catagories['attribute_type']=="DateTime" || $catagories['attribute_type']=="Date" || $catagories['attribute_type']=="Time"){?>
...
/////////////////////////////////
  ...
  <script type="text/javascript">
    ...
    function cloning() {
      ...
      $('.append-cat-data').last().append('<div class="col-sm-6 cloning marging" style="float: right;"><div class="form-group"><label for="lstRank" class="control-label  col-md-4" style="float:right;"><button class="btn btn-info clone-cat">More</button></label></div></div>');
      clone_cat();
    }
    function clone_cat() {
