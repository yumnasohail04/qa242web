...
$navigation = Modules:: run('permission/get_navigation', $role_id, DEFAULT_OUTLET);
 ...
 //echo 'wwwwwwwwwwwwww<pre>'; print_r($user_data); 
...
$arrMain = array('dashboard','webpages','categories','products','orders','sales','add_on','customers');
$arrHr = array('users','roles');
$arrSetup = array('outlet', 'general_setting','pos');
?>
...
<div class="page-sidebar-wrapper">
  <div class="page-sidebar navbar-collapse collapse">
    ...
    <ul class="page-sidebar-menu">
            ...
            ?>
          <li class="<?php   if($curr_url == $controller ){  echo 'active'; }   ?>"> <a href="<?php echo ADMIN_BASE_URL . $controller ?>"> <i class="fa"><img src="<?php echo base_url() . 'static/admin/theme1/images/' . $module_icons[$controller] ?>" alt="<?php echo $module_icons[$controller]; ?>"  rel="<?php echo base_url() . 'static/admin/theme1/images/' . $module_icons_hover[$controller] ?>" /></i> <span class="title"><?php echo ucwords(substr(str_replace('_', ' ', $controller), 0, 20));?></span>
            </a> </li>
          <?php endif; ?>
          <?php endforeach; 
            } ?>
