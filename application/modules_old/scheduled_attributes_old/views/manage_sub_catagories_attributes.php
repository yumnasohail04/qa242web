...
<div class="content-wrapper">
    <h3>Scheduled checks Attributes
    <a href="<?=ADMIN_BASE_URL?>scheduled_checks/"><button type="button" class="btn btn-primary "><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;&nbsp;Back to checks</button></a>
    <a href="<?php echo ADMIN_BASE_URL . 'scheduled_attributes/create/'.$ccheckid.'/'?>">
                         ...
                         <tbody class="courser table-body">
                                ...
                                if (isset($query)) {
                                    foreach ($query->result() as
                                        ...
                                        $edit_url = ADMIN_BASE_URL . 'scheduled_attributes/create/'.$ccheckid.'/'.$row->wip_id;
    ...
    /*//////////////////////// code for detail //////////////////////////*/
           ...
           // alert(id+pid); return false;
              $.ajax({
                        ...
                        url: "<?php echo ADMIN_BASE_URL?>scheduled_attributes/sub_details",
                        data: {'id': id},
                        async: false,
          ...
          $(document).off('click', '.delete_records').on('click', '.delete_records', function(e){
              ...
              swal({
                ...
                function () {
                       ...
                       $.ajax({
                            type: 'POST',
                            url: "<?php echo ADMIN_BASE_URL?>scheduled_attributes/delete_sub_catagories_attributes",
                            data: {'id': id , },
                            async: false,
                            success: function(typee) {
                               /*$( "#datatable1" ).load( "<? ADMIN_BASE_URL ?>scheduled_attributes/load_listing" );*/
                               location.reload();
                            }
                        });
    ...
    /*///////////////////////////////// START STATUS  ///////////////////////////////////*/
        ...
        $(document).off("click",".action_publish").on("click",".action_publish", function(event) {
            ...
            var status = $(this).attr('status');
             $.ajax({
                type: 'POST',
                url: "<?= ADMIN_BASE_URL ?>scheduled_attributes/change_status_sub_category",
                ...
                success: function(result) {
                    ...
                    $("#listing").load('<?php echo ADMIN_BASE_URL?>scheduled_attributes/manage');
