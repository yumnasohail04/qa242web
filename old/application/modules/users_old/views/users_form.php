                ...
                <div class="portlet-body form"> 
                   ...
                   <?php
                    ...
                    <div class="row">
                     <div class="col-sm-5">
                        <div class="form-group">
                          ...
                          $attribute = array('class' => 'control-label col-md-4');
                          echo form_label('Phone<span style="color:red">*</span>', 'phone', $attribute); ?>
                          <div class="col-md-8"> <?php echo form_input($data); ?> </div>
                        </div>
                      </div>
                      <div class="col-sm-5">
                    ...
                    <div class="row">
                     <div class="col-sm-5">
                        <div class="form-group">
                          <?php $options = array('' => 'Select')+$roles_title ;
                          $attribute = array('class' => 'control-label col-md-4');
                          echo form_label('Assign Role <span style="color:red">*</span>', 'role_id', $attribute);?>
                          <div class="col-md-8">
                            <?php echo form_dropdown('role_id', $options, $users['role_id'],  'class="form-control select2me required validatefield" id="role_id" tabindex ="8"'); ?>
                          </div>
                        </div>
                    </div>
                    <div class="col-sm-5">
                      <div class="form-group">
                        <?php $roles_title = array("admin"=>"admin","agent"=>"agent");
                        $options = array('' => 'Select')+$roles_title ;
                        $attribute = array('class' => 'control-label col-md-4');
                        echo form_label('Designation<span style="color:red">*</span>', 'designation', $attribute);?>
                        <div class="col-md-8">
                          <?php echo form_dropdown('designation', $options, $users['designation'],  'class="form-control select2me required validatefield" id="designation" tabindex ="9"'); ?>
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-5">
                      <div class="form-group">
                        <?php
                        $roles_title = array("Male"=>"Male","Female"=>"Female");
                        $options = array('' => 'Select')+$roles_title ;
                        $attribute = array('class' => 'control-label col-md-4');
                        echo form_label('Gender', 'gender', $attribute);?>
                        <div class="col-md-8">
                          <?php echo form_dropdown('gender', $options, $users['gender'],  'class="form-control select2me" id="gender" tabindex ="10"'); ?>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                      ...
                      ?>
                      <img src = "<?php echo BASE_URL.ACTUAL_OUTLET_USER_IMAGE_PATH.$users['user_image'] ?>" />
                      <?php
                      } else {
                      ?>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                         <div class="col-md-offset-3 col-md-9" style="padding-bottom:15px;">
                            <button type="submit" class="btn btn-primary buttonsubmit" tabindex="13" style="margin-left:10px;"><i class="fa fa-check"></i>&nbsp;Save</button>
