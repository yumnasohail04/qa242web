...
<div class="content-wrapper">
    <h3>Product<a href="product/create"><button type="button" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add New</button></a></h3>
              ...
              $.ajax({
                       ...
                       var test_desc = test_body;
                         ...
                         $("#myModalLarge .modal-body").html(test_desc);
                          $("#myModalLarge .modal-header").css('background','#d23232');
                          $("#myModalLarge .modal-footer").css('background','#272C32');
          ...
          $(document).off('click', '.delete_record').on('click', '.delete_record', function(e){
              ...
              swal({
                ...
                function () {
                       ...
                       $.ajax({
                            type: 'POST',
                            url: "<?php ADMIN_BASE_URL?>product/delete",
                            data: {'id': id},
                            async: false,
                            success: function() {
                            location.reload();
