...
//             }
    ...
    set_arr_date_range = function (p_indexes, dt_from, dt_to) {
        ...
        console.log(arr_tbl_columns_to_rows_distinct[p_indexes[0]]);
...
//#region Variables
var url_base =  (window.location.hostname=="https://qa.hwryk.com")?"/admin/":"/";
//var arr_ddl = {};
...
function load_chart_column_stacked(p_obj) {
    var options = {
        chart: {
            height: 150,
            type: 'bar',
        ...
        xaxis: {
            //type: 'datetime',
            categories: p_obj.xaxis//['01/01/2011 GMT', '01/02/2011 GMT', '01/03/2011 GMT', '01/04/2011 GMT', '01/05/2011 GMT', '01/06/2011 GMT'],
        },
        legend: {
            show: false,
            position: 'right',
    ...
    var chart = new ApexCharts(
        document.querySelector(p_obj.div_id_or_class),
        options
    );
...
function load_chart_pie_apex_arr(arr_chart_info, div_parent_id_or_class, div_child_id){
    ...
    arr_chart_info.forEach(function (item, index) {
        ...
        load_chart_pie_apex(new ClassChartPieApex(
...
function load_chart_pie_apex(chart_info){
    ...
    var options = {
        ...
        labels: chart_info.labels, // ['Team A', 'Team B', 'Team C', 'Team D', 'Team E'],
        series: chart_info.series,//[44, 55, 13, 43, 22],
        responsive: [{
            breakpoint: 480,
            options: {
                chart: {
    ...
    var chart_pie = new ApexCharts(
        document.querySelector(chart_info.div_id_or_class),
        options
    );
