            ...
            <div class="col-md-12">
                ...
                <div class="portlet box blue">
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                       <form method="post" id="submited_line" action="<?= ADMIN_BASE_URL.'notification_setting/submit_line_data/';?>">
                            <div class="form-body"> 
...
<script type="text/javascript">
  $(document).off('click', '.submited_line').on('click', '.submited_line', function(e){
    e.preventDefault();
    if(validateForm()) {
      $('#submited_line').attr('action', "<?= ADMIN_BASE_URL.'notification_setting/submit_line_data/';?>").submit();
    } else {
      //return
    }
  });
