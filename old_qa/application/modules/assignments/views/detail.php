                    ...
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                            <div class="form-body">
                                  ...
                                  if(isset($update_id) && !empty($update_id) && !empty($assign_id) && $function == "pending_review") {
                                    $product_check = Modules::run('api/_get_specific_table_with_pagination',array("assign_id"=>$update_id),'assign_id desc',DEFAULT_OUTLET.'_assignments','product_id','1','1')->result_array();
                                    $product_id = ""; 
                                    if(isset($product_check[0]['product_id']) && !empty($product_check[0]['product_id']) &&  $product_check[0]['product_id']!="0")
                                      $product_id = $product_check[0]['product_id'];
                                ...
                                <?php } ?>
                            <?php
                               if($function == "active_checks" || $function == "overdue_checks"){
                                 $product_check = Modules::run('api/_get_specific_table_with_pagination',array("assign_id"=>$update_id),'assign_id desc',DEFAULT_OUTLET.'_assignments','product_id','1','1')->result_array();
                            if(isset($product_check[0]['product_id']) && !empty($product_check[0]['product_id']) && $product_check[0]['product_id']!="0"){
                                ...
                                <table id="datatable1" class="table table-bordered">
                                        <tbody class="table-body">
                                          ...
                                          <tr class="bg-col">
                                              ...
                                              <td>
                                                <?php if(isset($checkname)) echo $checkname;?>
                                              </td>
                                          </tr>
                                            <?php if(isset($prodct_detail[0]['product_title']) && !empty($prodct_detail[0]['product_title']))  { ?>
                                          <tr class="bg-col">
                                              <th>
                                                   Product name:
                                              </th>
                                              <td>
                                                <?php $name=''; $name=$prodct_detail[0]['product_title']; $name=  Modules::run('api/string_length',$name,'8000',''); echo $name; ?>
                                              </td>
                                          </tr>
                                          <?php } ?>
                                          <tr class="bg-col">
                                 ...
                                 <table class="table table-bordered" style="color: black !important">
                                  ...
                                  <table class="table table-bordered" style="color: black !important">
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        <td><?php echo $value['question']; ?></td>
                                        <td>User will be asked to provide input value on mobile app</td>
