...
<head>
  <meta charset="UTF-8">
  <title>Verify Your Email on Udacity</title>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" style="font-family:'Open+Sans', 'Open Sans', Helvetica, Arial, sans-serif; font-size:13px; line-height:18px; color:#00C0EA; text-align:center; width:152px;">
                          ...
                          <tbody><tr>
                            <td style="padding:20px 0 10px 0;">
                              <a href="#tba" style="text-decoration:none;" target="_blank"><img alt="QA242" border="0" height="100" src="https://qa.hwryk.com/static/admin/theme1/images/logoqa.png" style="display:block; width:120px !important; font-family:'Open+Sans', 'Open Sans', Helvetica, Arial, sans-serif; font-size:22px; line-height:26px; color:#000000; text-transform:uppercase; text-align:center; letter-spacing:1px;" width="152"></a>
                            </td>
                          </tr>
                          ...
                          <tbody><tr>
                            <td style="text-align:center; padding:40px 40px 40px 40px; border-top:3px solid #02b3e4;">
                              ...
                              <div style="display:inline-block; width:100%; max-width:520px;">
                                ...
                                <tr>
                                	<td>
                                		 Your account has been created successfully at <span>QA242</span>, For futher account information contact to administration: <br><br>
                                	</td>
                                </tr>
<!--<tr>
                      ...
                      <tbody><tr>
                        <td align="center" style="padding:30px 0; border-bottom:1px solid #e5ebef;">
                          <table border="0" cellpadding="0" cellspacing="0" style="width:265px;">
                            <tbody><tr>
                                <?php if(isset($ios_link) && !empty($ios_link)){?>
                              <td align="center">
                                <a href="<?=$ios_link?>" target="_blank"><img alt="IOS" border="0" height="44" src="https://s3-us-west-2.amazonaws.com/udacity-email/Footer/ios-btn.gif" style="display:block; width:120px!important;" width="120"></a>
                              </td>
                              <?}?>
                               <?php if(isset($android_link) && !empty($android_link)){?>
                              <td align="center">
                                <a href="<?=$android_link?>" target="_blank"><img alt="Android" border="0" height="44" src="https://s3-us-west-2.amazonaws.com/udacity-email/Footer/android-btn.gif" style="display:block; width:120px!important;" width="120"></a>
                              </td>
                              <?}?>
                            </tr>
                          </tbody></table>
