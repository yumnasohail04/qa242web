...
<div class="content-wrapper">
    <h3>WIP
  <a href="<?=ADMIN_BASE_URL?>product/create_wips/<?=$product_id.'/0'?>"><button type="button" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add New</button></a></h3>
                        ...
                        <tbody>
                                ...
                                if (isset($news)) {
                                    foreach ($news->result() as
                                        ...
                                        $edit_url = ADMIN_BASE_URL . 'product/create_wips/' .$new->product_id.'/'. $new->id ;
                                    ...
                                    <tr id="Row_<?=$new->id?>" class="odd gradeX " >
                                        ...
                                        <td><?php echo wordwrap($new->parent_navision , 50 , "<br>\n")  ?></td>
                                        ...
                                        echo anchor($edit_url, '<i class="fa fa-edit"></i>', array('class' => 'action_edit btn blue c-btn','title' => 'Edit WIP'));
