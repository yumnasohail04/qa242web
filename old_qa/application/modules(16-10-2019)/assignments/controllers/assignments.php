...
//Modules::run('site_security/has_permission');
    ...
    function today_checks() {
        $where['assignments.start_datetime >='] = date('Y-m-d')." 00:00:00";
        $where['assignments.end_datetime <='] = date('Y-m-d')." 23:59:59";
        $data['news'] = $this->_get('id desc',$where);
        $data['view_file'] = 'news';
        $groups = Modules::run('api/_get_specific_table_with_pagination',array(), 'id desc',DEFAULT_OUTLET.'_groups','id,group_title','1','0')->result_array();
        $data['groups'] = $groups;
    ...
    function static_forms_pending() {
        ...
        $data['page_number'] = 1; 
        $data['limit'] = 20;
        $res = Modules::run('api/_get_specific_table_with_pagination_and_where',array("assign_status"=>"Pending","complete_datetime >="=> date("Y-m-d")." 00:00:00","complete_datetime <="=> date("Y-m-d")." 23:59:59"), 'assign_id desc',DEFAULT_OUTLET.'_static_assignments','assign_id,complete_datetime,assign_status,check_id,inspection_team',$data['page_number'],$data['limit'],'','','')->result_array();
        $groups = Modules::run('api/_get_specific_table_with_pagination',array(), 'id desc',DEFAULT_OUTLET.'_groups','id,group_title','1','0')->result_array();
        ...
        $data['total_pages'] = Modules::run('api/_get_specific_table_with_pagination_and_where',array("assign_status"=>"Pending","complete_datetime >="=> date("Y-m-d")." 00:00:00","complete_datetime <="=> date("Y-m-d")." 23:59:59"), 'assign_id desc',DEFAULT_OUTLET.'_static_assignments','assign_id,complete_datetime,assign_status,check_id,inspection_team','1','0','','','')->num_rows();
        $data['result'] = $res;
    ...
    function static_forms_reviewed() {
        ...
        $data['page_number'] = 1; 
        $data['limit'] = 20;
        $res = Modules::run('api/_get_specific_table_with_pagination_and_where',array("assign_status"=>"Reviewed","review_datetime >="=> date("Y-m-d")." 00:00:00","review_datetime <="=> date("Y-m-d")." 23:59:59"), 'assign_id desc',DEFAULT_OUTLET.'_static_assignments','assign_id,complete_datetime,assign_status,check_id,inspection_team,review_user',$data['page_number'],$data['limit'],'','','')->result_array();
        $groups = Modules::run('api/_get_specific_table_with_pagination',array(), 'id desc',DEFAULT_OUTLET.'_groups','id,group_title','1','0')->result_array();
        foreach($res as $key=>$value)
        {
            $r_user = Modules::run('api/_get_specific_table_with_pagination_and_where',array("sf_id"=>$value['check_id']), 'sf_id desc',DEFAULT_OUTLET.'_static_form','sf_name','','','','','')->result_array();
        ...
        $data['total_pages'] = Modules::run('api/_get_specific_table_with_pagination_and_where',array("assign_status"=>"Reviewed","review_datetime >="=> date("Y-m-d")." 00:00:00","review_datetime <="=> date("Y-m-d")." 23:59:59"), 'assign_id desc',DEFAULT_OUTLET.'_static_assignments','assign_id,complete_datetime,assign_status,check_id,inspection_team','1','0','','','')->num_rows();
        $data['result'] = $res;
    ...
    function static_forms_approved() {
        ...
        $data['page_number'] = 1; 
        $data['limit'] = 20;
        $res = Modules::run('api/_get_specific_table_with_pagination_and_where',array("assign_status"=>"Approved","approval_datetime >="=> date("Y-m-d")." 00:00:00","approval_datetime <="=> date("Y-m-d")." 23:59:59"), 'assign_id desc',DEFAULT_OUTLET.'_static_assignments','assign_id,complete_datetime,assign_status,check_id,inspection_team,review_user,approval_user',$data['page_number'],$data['limit'],'','','')->result_array();
        $groups = Modules::run('api/_get_specific_table_with_pagination',array(), 'id desc',DEFAULT_OUTLET.'_groups','id,group_title','1','0')->result_array();
        foreach($res as $key=>$value)
        {
            $r_user = Modules::run('api/_get_specific_table_with_pagination_and_where',array("sf_id"=>$value['check_id']), 'sf_id desc',DEFAULT_OUTLET.'_static_form','sf_name','','','','','')->result_array();
        ...
        $data['total_pages'] = Modules::run('api/_get_specific_table_with_pagination_and_where',array("assign_status"=>"Approved","approval_datetime >="=> date("Y-m-d")." 00:00:00","approval_datetime <="=> date("Y-m-d")." 23:59:59"), 'assign_id desc',DEFAULT_OUTLET.'_static_assignments','assign_id,complete_datetime,assign_status,check_id,inspection_team','1','0','','','')->num_rows();
