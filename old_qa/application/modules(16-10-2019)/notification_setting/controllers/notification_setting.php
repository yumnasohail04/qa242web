...
class Notification_setting extends MX_Controller
{
...
Modules::run('site_security/has_permission');
    ...
    function submit_plant_data() {
      ...
      redirect(ADMIN_BASE_URL.'notification_setting');
    }
...
///////////////////////////     HELPER FUNCTIONS    ////////////////////
    ...
    function _get($order_by) {
        $this->load->model('mdl_notification_setting');
        $query = $this->mdl_notification_setting->_get($order_by);
        return $query;
    }
    ...
    function _insert($data) {
        $this->load->model('mdl_notification_setting');
        return $this->mdl_notification_setting->_insert($data);
    }

    function delete_table_data(){
        $this->load->model('mdl_notification_setting');
        return $this->mdl_notification_setting->delete_table_data();
    }
    function get_product_schedules_from_db($cols, $order_by,$group_by='',$outlet_id,$select,$page_number,$limit,$or_where='',$and_where='',$having=''){
            $this->load->model('mdl_notification_setting');
        $query = $this->mdl_notification_setting->get_product_schedules_from_db($cols, $order_by,$group_by,$outlet_id,$select,$page_number,$limit,$or_where,$and_where,$having);
        return $query;
    }
}