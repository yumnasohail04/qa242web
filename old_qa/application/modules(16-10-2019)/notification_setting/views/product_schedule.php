            ...
            <div class="col-md-12">
                ...
                <div class="portlet box blue">
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                       <form method="post" id="submited_form" action="<?= ADMIN_BASE_URL.'notification_setting/submit_product_reschedule/';?>">
                            <div class="form-body"> 
                                    ...
                                    <div class="group_div" style="clear: both; padding-top: 10px;">
                                     ...
                                     <div class="col-sm-12 selecting_div">
                                             <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                   <select  multiple class="form-control restaurant_type chosen-select "  data-show-subtext="true" data-live-search="true" name="groups[]" required="required">
                                                      <option value="">Select</option>
                                                    <option  value="bread" data-subtext="23423432423">bread</option>
                                                    <option  value="apple" data-subtext="234234324dfgfdgd23">apple</option>
                                                   </select>
                                                </div>
                                             </div>
...
<script type="text/javascript">
  $(document).off('click', '.submit_from').on('click', '.submit_from', function(e){
    e.preventDefault();
    if(validateForm()) {
      $('#submited_form').attr('action', "<?= ADMIN_BASE_URL.'notification_setting/submit_product_reschedule/';?>").submit();
    } else {
      //return
    }
  });
