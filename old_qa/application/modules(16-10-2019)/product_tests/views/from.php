            ...
            <div class="col-md-12">
               ...
               <div class="col-sm-8">
                        <div class="form-group">
                          ...
                          <div class="col-md-8">
                            <?php echo form_dropdown('checktype', $options, $users['group'],  'class="form-control select2me required validatefield" id="role_id" tabindex ="8"'); ?>
                          </div>
                        </div>
                    </div>
                     <div class="col-sm-8">
                    ...
                    <div class="col-sm-8">
                        <div class="form-group select_box">
                          ...
                          <div class="col-md-8">
                            <?php echo form_dropdown('productid', $options, $news['group'],  'class="form-control select_attributes  required validatefield selectpicker show-tick" data-live-search="true" id="product_id" tabindex ="8"'); ?>
                          </div>
                        </div>
                    </div>
        ...
        <div class="col-xs-12">
            <div class="col-md-12">
                <h3>Select Responsible Team </h3>
                 <div class="col-sm-5">
                        <div class="form-group">
                         <label class="col-sm-4 control-label">Select  Team</label>
                           <div class="col-sm-8">
                      <select multiple class="chosen-select form-control restaurant_type" name="restaurant_type[]">
                        ...
                        if(!isset($groups) || empty($groups))
                          ...
                          foreach ($groups as $value): ?>
                             <option value="<?=$value['id']?>" <?php  if($value['id']== $users['group']) echo 'selected="selected"'; ?>><?= $value['group_title']?></option>
            ...
            <div class="col-md-12">
                            ...
                            <div class="form-group">
                             ...
                             <?php $options = array('' => 'Select')+$frequency ;?>
                               ...
                               <div class="col-md-8">
                            <?php echo form_dropdown('frequency', $options, $users['group'],  'class="form-control select2me required validatefield" id="role_id" tabindex ="8"'); ?>
                          </div>
                            </div>
                        </div>
                         ...
                         <div class="col-sm-5">
                             <?php $news_date='';
                                if (isset($news['start_date']) && $news['start_date'] != "0000-00-00" && !empty($news['start_date'])) {
                                    $news_date = date('Y/m/d', strtotime($news['start_date']));
