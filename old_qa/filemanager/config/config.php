...
if($_SERVER['HTTP_HOST'] == 'ds-pc' || $_SERVER['HTTP_HOST'] == 'localhost')
		$BASE_URL = ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'].'/appligions_v2';
	else
...
$config = array(
	...
	*/
		'base_url' => $BASE_URL,
	//'base_url' => 'http://broadclass.rnn.digitalspinners.com',
	/*
	|--------------------------------------------------------------------------
	...
	*/
	...
	'upload_dir' => '/uploads/media/'.$strHost.'/',
	...
	|
	*/
	'current_path' => '../uploads/media/'.$strHost.'/',
	//'current_path' => '../http://broadclass.rnn.digitalspinners.com/source/',
